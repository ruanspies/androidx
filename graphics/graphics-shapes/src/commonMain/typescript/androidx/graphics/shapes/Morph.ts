...
import { featureMapper, MeasuredFeatures } from "./FeatureMapping";
import { AngleEpsilon, debugLog, interpolate, positiveModulo, DEBUG } from "./Utils";
import { Point } from "./Point";
import { toStringWithLessPrecision } from "./String";
import { MeasuredPolygon, LengthMeasurer, MeasuredCubic } from './PolygonMeasure';
...
export class Morph {
    ...
    private static match(p1: RoundedPolygon, p2: RoundedPolygon): [Cubic, Cubic][] {
        ...
        while (b1 && b2) {
            ...
            let seg1: MeasuredCubic, newb1: MeasuredCubic | null;
            ...
            let seg2: MeasuredCubic, newb2: MeasuredCubic | null;
